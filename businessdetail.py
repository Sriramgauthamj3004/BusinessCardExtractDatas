# -*- coding: utf-8 -*-
"""businessdetail.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1R6iNopPS_0d-SwBxZGAWl5-aHv4Lm944
"""
...
st.set_page_config(layout="wide",page_title="Bizcard EasyOCR",
                   page_icon=Image.open('/content/drive/MyDrive/img/image.png'))
...
if choice == "Home":
    ...
    with col1:
        lottie1 = load_lottiefile("/content/drive/MyDrive/media/biz.json.json")
    ...
    with col2:
        lottie2 = load_lottiefile("/content/drive/MyDrive/media/biz.json.json")
        st_lottie(lottie2, height=400)
    col1,col2 = st.columns(2)
    with col1:
        lottie3 = load_lottiefile("/content/drive/MyDrive/media/biz.json.json")
